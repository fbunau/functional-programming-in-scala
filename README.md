...
1. Introduction to functional programming
   ...
   - Functional data structures
      ...
      + [HOF: foldRight - sum, product, length - generalized implementations](src/main/scala/_1_Introduction_to_functional_programming/_3_Functional_data_structures/List.scala#L64-L76)
      + [HOF: foldLeft  - sum, product, length - generalized implementations](src/main/scala/_1_Introduction_to_functional_programming/_3_Functional_data_structures/List.scala#L80-L93)
